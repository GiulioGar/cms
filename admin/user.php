...
@$dettagli = $_REQUEST['dettagli'];
        ...
        $user2 = mysqli_query($admin,$query_user2) or die(mysqli_error());
		...
		$m2_close = mysqli_query($admin,$query_m2) or die(mysqli_error());
		$surComp = mysqli_fetch_assoc($m2_close);


mysqli_select_db($admin,$database_admin);
$query_user = "SELECT * FROM t_user_info WHERE user_id = '$user_id'";
$user = mysqli_query($admin,$query_user) or die(mysqli_error());
...
$crm2 = mysqli_query($admin,$query_crm2) or die(mysqli_error());
...
$story2 = mysqli_query($admin,$query_story) or die(mysqli_error());
