...
$new_fbb = mysqli_query($query_new, $admin) ;
...
$new_fmb = mysqli_query($query_new, $admin) ;
...
$new_mb = mysqli_query($query_new, $admin) ;
...
$new_mvf = mysqli_query($query_new, $admin) ;
...
$new_mvfGirl = mysqli_query($query_new, $admin) ;
...
$new_mvf2 = mysqli_query($query_new, $admin) ;
...
$new_mvf25 = mysqli_query($query_new, $admin) ;
...
$new_mvf2Girl = mysqli_query($query_new, $admin) ;
...
$tot_mvfFirst = mysqli_query($query_user, $admin) ;
...
$csv_mvf = mysqli_query($query_new, $admin) ;
