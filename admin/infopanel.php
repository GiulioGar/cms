...
$query_sel = "SELECT user_id,province_id
FROM t_user_info";
$csv_sel = mysqli_query($admin,$query_sel);	

while ($row = mysqli_fetch_assoc($csv_sel))
{
    $selAmp=$arrayProv[1][$row['province_id']];
    $selUid=$row['user_id'];
