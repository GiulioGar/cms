...
<table>
	...
	<tr>
		<td colspan="2" ><input type="submit" value="TAG"></td>
	</tr>
</table>
</form>
</div>
...
<div class="contieniDestra">

<div class="statusRic">

<div class="inRic">

<div class='intestaz'>STATUS RICERCA</div>
		<?php if ($contaPan>1) 		
		{ ?>
	...
	<?php 
		...
		<div class="tabGen" style="float:left;" >
		<table class="tabdat"  >
		<tr class="intesta"><th colspan='2'>Panel Millebytes</th></tr> 
...
<?php if ($panel_esterno>0) 		
		...
		<div class="tabGen"  <?php if ($contaIns<5) { echo "style='float:left;'"; }?> >
		<table class="tabdat">
		...
		<div <?php if ($contaIns<3 || $contaIns>4) { echo "style='float:left;'"; }?>   class="tabGen">
		<table class="tabdat">
		...
		<?php
			...
			$num_righe = mysql_num_rows($tot_quo);
...
<div id="contDia">  
<div class='intestaz'>DIARIO RICERCA</div>
