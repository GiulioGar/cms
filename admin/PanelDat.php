...
<div class="col-md-4 col-sm-4">
	 <div class="panel panel-default">
				...
				<tr><th>Periodo</th><th>Tot.</th><th>%</th><th>Uomini</th><th>Donne</th></tr>
...
<div class="panel panel-success">
			...
			<table class="table table-striped table-bordered" style="font-size:12px">
					<tr><th colspan="3"  ><span style="color:#032B51"></span></th></tr>
					<tr class="intesta"><th>Periodo</th><th>Tot.</th></tr>
...
<div class="row">		
	...
	<div class="panel panel-info">
		...
		<div class="panel-body">
				...
				<tr><td>Ricerche Int.:</td> <td><b><?php echo $contaInt16; ?></b></td><td><b><?php echo $contaInt; ?></b></td><td><b><?php echo $contaInt17; ?></b></td> </tr>
				<tr><td>Ricerche Est.:</td><td><b><?php echo $contaExt16; ?></b></td><td><b><?php echo $contaExt; ?></b></td><td><b><?php echo $contaExt17; ?></b></td> </tr>
				<tr><td>Complete Int.</td><td><b><?php echo $compInt16;  ?></b></td> <td><b><?php echo $compInt;  ?></b></td><td><b><?php echo $compInt17;  ?></b></td> </tr>
				<tr><td>Complete Est.</td><td><b><?php echo $compExt16;  ?></b></td> <td><b><?php echo $compExt;  ?></b></td><td><b><?php echo $compExt17;  ?></b></td> </tr>
				<tr><td>Complete Int. Ita</td><td><b><?php echo $italiainterne2016." (".$percentualeinterne2016."%)";  ?></b></td><td><b><?php echo $italiainterne2018." (".$percentualeinterne2018."%)";  ?></b></td><td><b><?php echo $italiainterne2017." (".$percentualeinterne2017."%)";  ?></b></td>  </tr>
				<tr><td>Complete Est Ita</td><td><b><?php echo $italiaesterne2016." (".$percentualeesterne2016."%)";  ?></b></td><td><b><?php echo $italiaesterne2018." (".$percentualeesterne2018."%)";  ?></b></td> <td><b><?php echo $italiaesterne2017." (".$percentualeesterne2017."%)";  ?></b></td> </tr>
...
<div class="panel panel-warning">
	...
	<table class="table table-striped table-bordered" style="font-size:12px">
				...
				<tr><td>IR</td><td><input class="form-control" name="ir" size="2" type="input" value="<?php echo $ir; ?>" /></td></tr>
				<tr><td>Totali:</td><td><?php echo  sprintf("%01.0f",$ageComp); ?></td></tr>
				<tr><td>Uomini:</td><td><?php echo sprintf("%01.0f",$mComp); ?></td></tr>
				<tr><td>Donne:</td><td><?php echo sprintf("%01.0f",$fComp); ?></td></tr>
				<tr>
				...
				<tr><td colspan="2"><input class="btn btn-danger" type="submit" value="CALCOLA" style="width:80%"/></td>
				</table>
	</form>			
	</div>
...
<div class="col-md-4 col-sm-4">
 ...
 <div class="panel panel-danger">
                 ...
                 <div class="panel-body">
				<table class="table table-striped table-bordered" style="font-size:12px">
				<tr><th>Paese</th><th>N. Ric. '18</th><th>Casi '18</th><th>N. Ric. '17</th><th>Casi '17</th><th>N. Ric. '16</th><th>Casi '16</th></tr>
				<tr><td>Italia</td><td><?php echo $italia2018['total']; ?></td><td><?php echo $italia_c2018['complete_ext']; ?></td><td><?php echo $italia2017['total']; ?></td><td><?php echo $italia_c2017['complete_ext']; ?></td><td><?php echo $italia2016['total']; ?></td><td><?php echo $italia_c2016['complete_ext']; ?></td></tr>
				<tr><td>UK</td><td><?php echo $uk2018['total']; ?></td><td><?php echo $uk_c2018['complete_ext']; ?></td><td><?php echo $uk2017['total']; ?></td><td><?php echo $uk_c2017['complete_ext']; ?></td><td><?php echo $uk2016['total']; ?></td><td><?php echo $uk_c2016['complete_ext']; ?></td></tr>
			    <tr><td>Germania</td><td><?php echo $germania2018['total']; ?></td><td><?php echo $germania_c2018['complete_ext']; ?></td><td><?php echo $germania2017['total']; ?></td><td><?php echo $germania_c2017['complete_ext']; ?></td><td><?php echo $germania2016['total']; ?></td><td><?php echo $germania_c2016['complete_ext']; ?></td></tr>
				<tr><td>Francia</td><td><?php echo $francia2018['total']; ?></td><td><?php echo $francia_c2018['complete_ext']; ?></td><td><?php echo $francia2017['total']; ?></td><td><?php echo $francia_c2017['complete_ext']; ?></td><td><?php echo $francia2016['total']; ?></td><td><?php echo $francia_c2016['complete_ext']; ?></td></tr>
				<tr><td>Spagna</td><td><?php echo $spagna2018['total']; ?></td><td><?php echo $spagna_c2018['complete_ext']; ?></td><td><?php echo $spagna2017['total']; ?></td><td><?php echo $spagna_c2017['complete_ext']; ?></td><td><?php echo $spagna2016['total']; ?></td><td><?php echo $spagna_c2016['complete_ext']; ?></td></tr>
				<tr><td>Altro</td><td><?php echo $altro2018['total']; ?></td><td><?php echo $altro_c2018['complete_ext']; ?></td><td><?php echo $altro2017['total']; ?></td><td><?php echo $altro_c2017['complete_ext']; ?></td><td><?php echo $altro2016['total']; ?></td><td><?php echo $altro_c2016['complete_ext']; ?></td></tr>
				</table>
				</div>
					<div class="panel-footer">
       &nbsp;
...
<div class="panel-body">
<table class="table table-striped table-bordered" style="font-size:12px">
<tr> <th>Livello </th><th>Utenti</th><th>&nbsp;</th></tr>
<?php	  
