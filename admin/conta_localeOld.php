...
//echo "la ricerca è:".$sid." ".$prj;
	  ...
	  $tot_targ = mysqli_query($query_trg, $admin) or die(mysql_error());     
...
//// ESPORTA CAMPIONE MVF IN CSV ////
	...
	@$csv_attivi="uid;email;firstName;genderSuffix";
    $csv_attivi .= "\n";
    ...
    { 
            ...
            $csv_attivi .=$uid.";".$mail.";".$nome.";".$genderTransform; 
            $csv_attivi .= "\n";
    } 
...
//Altezza menu a sinistra
        $(document).ready(function() {
		var altezza=0;
        var altezzaDia=$('.containDia').height();
        var altezzaTab=$('.containTab').height();
		altezza=altezzaDia+altezzaTab+5;
		$('.contSur').css('height',altezza);
		$('.infoSur').css('height',altezza-15);
...
<div style="padding:10px" class="contSur survey">
...
<div class="infopt"><div class="desc">&nbsp;</div>&nbsp;</div>
<div class="infopt"><div class="desc"><b>Durata intervista (Media):</b></div><b><span style="color:red"><?php echo substr($loi,0,4); ?> minuti</span></b></div>
<div class="infopt"><div class="desc">&nbsp;</div>&nbsp;</div>
		<?php if ($panel_in==1) 		
		{ ?>
<div class="infopt">
...
<table>
	...
	<tr>
		<td colspan="2" align="center"><input type="submit" value="TAG"></td>
	</tr>
</table>
</form>
</div>
...
<div class="campioni">
		<div class="intestaDia">DOWNLOAD SOLLECITO</div>		
			...
			<div style="float:left">
				<form  style="width: 50px" action="csv.php" method="post" target="_blank">
				<input type="hidden" name="csv" value="<?php echo htmlspecialchars($csv_attivi) ?>" />
				<input type="hidden" name="filename" value="user_list" />
				<input type="image" value="submit" src="img/CSV.gif" />
				Attivi
				</form>		
...
<div class="result"  style="float:left; width:40%;" >
...
<div style="width:50%; margin-left:58%" class="traccia">
		<div class="intestaDia">TRACCIA FILTRATE/SOSPESE</div>
		
		
		<div style="float:left;">
		<table class="tabdat">
		<tr class="intesta"><th colspan='4'><span style="color:red"><b>Traccia filtrate</b></span></th></tr>
		...
		<table class="tabdat">
		<tr class="intesta"><th colspan='4'><span style="color:red"><b>Traccia sospese</b></span></th></tr>
		<tr><td>Domanda</td><td>Cod.</td><td>Num.</td><td>%</td></tr>
		<?php
		$contaImm2==0;
...
<div class="containDia" style="float:left;">
...
//AGGIORNA COMPLETE DIVISE PER INTERNO ED ESTERNO
	...
	mysqli_select_db($database_admin, $admin);
	$query_compInt = "UPDATE t_panel_control set complete_int='".$conta_complete_panel."',complete_ext='".$conta_complete_ssi."',durata='".substr($loi,0,4)."' where sur_id='".$sid."'";
	$aggiorna_compInt = mysqli_query($query_compInt, $admin) or die(mysql_error());
...
<div class="intestaQuo" >QUOTE ASSEGNATE</div>
<table class="tabdat">
	<tr class="intesta"><th colspan='4'><span style="color:red"><b>QUOTE</b></span></th></tr>
<?php
	$query_quo = "SELECT * FROM millebytesdb.t_quota_status where survey_id='$sid' and project_name='$prj'";
	$tot_quo = mysqli_query($query_quo, $admin) or die(mysql_error());
	...
	while ($row = mysqli_fetch_assoc($tot_quo))
		...
		$diffQuo=$row['current_value']-$row['target_value'];
		  ...
		  echo "<tr><td><b>".$row['target_name']."</b></td><td>".$row['target_value']."</td><td>".$row['current_value']."</td><td>".$diffQuo."</td></tr>";
		}
...
{
$costo=$conta_complete_panel*0.20;

mysqli_select_db($database_admin, $admin);
$query_aggiorna_statistiche_costo = "UPDATE t_panel_control set costo='".$costo."' where sur_id='".$sid."'";
$aggiorna_statistiche_costo = mysqli_query($query_aggiorna_statistiche_costo, $admin) or die(mysql_error());
