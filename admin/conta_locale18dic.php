...
<div style="float:left;">
<table class="tabdat">
<tr class="intesta"><th colspan='2'>Panel Interactive</th></tr>
<tr>
<td>
Complete:
</td>
...
<div style="float:left;">
<table class="tabdat">
<tr class="intesta"><th colspan='2'>Calcolo stima</th></tr>
<tr>
<td>
Utenti disponibili
</td>
...
<table class="tabdat">
<tr class="intesta"><th colspan='6'>DIARIO TOTALE</th></tr>
<tr><td>Giorno</td><td>Complete</td><td>Non in target</td><td>Over Quota</td><td>Sospese</td><td>Redemption Field (IR)</td></tr>
<?php
...
echo "<tr><td>".$chiave."</td><td>".$diario_complete[$chiave]."</td><td>".$diario_filtrati[$chiave]."</td><td>".$diario_quotafull[$chiave]."</td><td>".$diario_incomplete[$chiave]."</td><td>".$redemption_field_giornaliero."%</td></tr>";
}
?>
</table>
</div>
...
<table class="tabdat">
<tr class="intesta"><th colspan='8'>DIARIO Panel Interactive</th></tr>
<tr><td>Giorno</td><td>Complete</td><td>Non in target</td><td>Over Quota</td><td>Sospese</td><td>Redemption Field (IR)</td><td>Abilitati</td><td>Redemption Panel Field</td></tr>
<?php
...
echo "<tr><td>".$chiave."</td><td>".$diario_complete_panel[$chiave]."</td><td>".$diario_filtrati_panel[$chiave]."</td><td>".$diario_quotafull_panel[$chiave]."</td><td>".$diario_incomplete_panel[$chiave]."</td><td>".$redemption_field_giornaliero."%</td><td>".$abilitati_totali_sample."</td><td>".$red_panel_sample."%</td></tr>";
}
?>
</table>
</div>
...
<table class="tabdat">
<tr class="intesta"><th colspan='6'>DIARIO Panel Esterno</th></tr>
<tr><td>Giorno</td><td>Complete</td><td>Non in target</td><td>Over Quota</td><td>Sospese</td><td>Redemption Field (IR)</td></tr>
<?php
...
echo "<tr><td>".$chiave."</td><td>".$diario_complete_ssi[$chiave]."</td><td>".$diario_filtrati_ssi[$chiave]."</td><td>".$diario_quotafull_ssi[$chiave]."</td><td>".$diario_incomplete_ssi[$chiave]."</td><td>".$redemption_field_giornaliero."%</td></tr>";
}
?>
</table>
</div>
