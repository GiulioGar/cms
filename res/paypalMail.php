...
//lettura livello
// $query_cerca_email = "SELECT email FROM t_user_info where t_user_info.user_id='$userId'";
    ...
    <div class="container">
        <div class="row">
           ...
           <div class="contOk">
                ...
                <p> 
             <h2>Grazie, la tua email &egrave; stata inserita correttamente. <p>Nei prossimi giorni riceverai la tua ricarica!</p></h2>
                </p>
            </div>
